...
exports.getTotalUserListBalance = async (req, res, next) => {
  try {
    ...
    const totalBalance = await getMultipleUserWithTotalUsersBalanceData(where, apiQuery, queryColumns);
