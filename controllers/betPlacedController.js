...
const { betStatusType, teamStatus, matchBettingType, betType, redisKeys, betResultStatus, marketBetType, userRoleConstant, expertDomain, partnershipPrefixByRole, microServiceDomain, socketData, walletDomain,   casinoMicroServiceDomain, cardGameType, sessionBettingType,  oldBetFairDomain } = require("../config/contants");
const { logger } = require("../config/logger");
const { getUserRedisData, getUserRedisKey, incrementValuesRedis, setCardBetPlaceRedis } = require("../services/redis/commonfunction");
const { getUserById } = require("../services/userService");
const { apiCall, apiMethod, allApiRoutes } = require("../utils/apiService");
const {  calculateProfitLossSession, calculatePLAllBet, mergeProfitLoss, findUserPartnerShipObj, forceLogoutUser, parseRedisData, calculateRacingRate, calculateProfitLossForRacingMatchToResult, profitLossPercentCol, calculateProfitLossSessionOddEven, calculateProfitLossSessionCasinoCricket, calculateProfitLossSessionFancy1, checkBetLimit, calculateProfitLossKhado, calculateProfitLossMeter } = require('../services/commonService');
const { SessionMatchBetQueue, WalletSessionBetQueue, ExpertSessionBetQueue, walletSessionBetDeleteQueue, expertSessionBetDeleteQueue, CardMatchBetQueue, WalletCardMatchBetQueue, MatchTournamentBetQueue, WalletMatchTournamentBetQueue, ExpertMatchTournamentBetQueue, walletTournamentMatchBetDeleteQueue, expertTournamentMatchBetDeleteQueue } = require('../queue/consumer');
